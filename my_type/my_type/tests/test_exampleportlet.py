...
from my_type.my_type.portlets import exampleportlet
from my_type.my_type.portlets.tests.base_exampleportlet import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='my_type.my_type.portlets.ExamplePortlet')
        self.assertEquals(portlet.addview, 'my_type.my_type.portlets.ExamplePortlet')
